...
public static class Strings
{
    ...
    private static readonly Dictionary<string, string[]> Map = new()
    {
        ...
        ["Terminal.Empty"] = ["Output from brew commands appears here.", "La sortie des commandes brew apparaît ici.", "La salida de los comandos brew aparece aquí.", "Die Ausgabe der brew-Befehle erscheint hier."],
